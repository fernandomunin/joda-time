...
public class FieldUtils {
    ...
    private static void throwOverflowException(long val1, int val2) {
        throw new ArithmeticException("Multiplication overflows a long: " + val1 + " * " + val2);
    }

    private static void checkMinValue(long val1, int val2) {
        if (val1 == Long.MIN_VALUE) {
            throwOverflowException(val1, val2);
        }
    }
